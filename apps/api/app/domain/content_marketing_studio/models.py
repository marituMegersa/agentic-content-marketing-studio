...
class AgenticContentMarketingStudioSession(Base):
    __tablename__ = "content_marketing_studio_sessions"
...
class AgenticContentMarketingStudioItem(Base):
    __tablename__ = "content_marketing_studio_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("content_marketing_studio_sessions.id"))
