...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Content Marketing Studio</h1>
      <p style={{ color: '#666' }}>Autonomous multi-agent content strategy planner, SEO keyword researcher, multi-format article author, and social publisher.</p>
